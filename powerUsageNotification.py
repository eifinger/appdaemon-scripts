...
class PowerUsageNotification(hass.Hass):
    ...
    def state_change(self, entity, attribute, old, new, kwargs):
        ...
        if ( not self.triggered and new > self.threshold ):
            self.triggered = True
            self.log("Power Usage is: {}".format(new))
        ...
        elif ( self.triggered and self.isWaitingHandle == None and new <= self.threshold):
