...
class PlantWateringNotifier(hass.Hass):
    ...
    def initialize(self):
        ...
        self.timer_handle_list.append(self.run_daily(run_morning_callback,time = datetime.time(8, 0, 0)))
        #Remind daily at 18:00
        self.timer_handle_list.append(self.run_daily(run_evening_callback,time = datetime.time(18, 0, 0)))
    ...
    def run_morning_callback(self, kwargs):
        ...
        self.log("Precip Type: {}".format(self.precip_type))
